...
def main(
    ...
    model: str | None = typer.Option(
        ...
        "--model",
        "-m",
        help="Model alias (e.g. 'sonnet', 'opus') or full model ID. Falls back to $OH_MODEL.",
        envvar="OH_MODEL",
    ...
    base_url: str | None = typer.Option(
        None,
        "--base-url",
        help="API base URL. Falls back to $OH_BASE_URL.",
        envvar="OH_BASE_URL",
        rich_help_panel="System & Context",
    ),
    api_key: str | None = typer.Option(
        ...
        "--api-key",
        "-k",
        help="API key (overrides config). Falls back to $OH_API_KEY.",
        envvar="OH_API_KEY",
        rich_help_panel="System & Context",
    ),
    ...
    api_format: str | None = typer.Option(
        None,
        "--api-format",
        help="API format: 'anthropic' (default), 'openai' (DashScope, GitHub Models, vLLM, etc.), or 'copilot' (GitHub Copilot). Falls back to $OH_API_FORMAT.",
        envvar="OH_API_FORMAT",
        rich_help_panel="System & Context",
    ),
